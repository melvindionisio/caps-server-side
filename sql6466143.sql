...
-- Schema sql6466143
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sql6466143` DEFAULT CHARACTER SET utf8 ;
USE `sql6466143` ;

-- -----------------------------------------------------
-- Table `sql6466143`.`admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql6466143`.`admin` (
...
-- -----------------------------------------------------
-- Table `sql6466143`.`boarding_house_owners`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql6466143`.`boarding_house_owners` (
...
-- -----------------------------------------------------
-- Table `sql6466143`.`boarding_house`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql6466143`.`boarding_house` (
  ...
  INDEX `fk_BOARDING_HOUSE_BOADING_HOUSE_OWNERS1_idx` (`bho_id` ASC) ,
  CONSTRAINT `fk_BOARDING_HOUSE_BOADING_HOUSE_OWNERS1`
    FOREIGN KEY (`bho_id`)
    REFERENCES `sql6466143`.`boarding_house_owners` (`bho_id`))
ENGINE = InnoDB
AUTO_INCREMENT = 4
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `sql6466143`.`boarding_house_seekers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql6466143`.`boarding_house_seekers` (
...
-- -----------------------------------------------------
-- Table `sql6466143`.`rooms`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql6466143`.`rooms` (
  ...
  PRIMARY KEY (`room_id`),
  INDEX `fk_ROOMS_BOARDING_HOUSE1_idx` (`boardinghouse_id` ASC) ,
  CONSTRAINT `fk_ROOMS_BOARDING_HOUSE1`
    FOREIGN KEY (`boardinghouse_id`)
    REFERENCES `sql6466143`.`boarding_house` (`boardinghouse_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;


-- -----------------------------------------------------
-- Table `sql6466143`.`bookmarks`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql6466143`.`bookmarks` (
  ...
  INDEX `fk_BOOKMARKS_BOARDING_HOUSE_SEEKERS_idx` (`seeker_id` ASC) ,
  INDEX `fk_BOOKMARKS_ROOMS1_idx` (`room_id` ASC) ,
  INDEX `fk_BOOKMARKS_BOARDING_HOUSE1_idx` (`boardinghouse_id` ASC) ,
  CONSTRAINT `fk_BOOKMARKS_BOARDING_HOUSE1`
    FOREIGN KEY (`boardinghouse_id`)
    REFERENCES `sql6466143`.`boarding_house` (`boardinghouse_id`),
  CONSTRAINT `fk_BOOKMARKS_BOARDING_HOUSE_SEEKERS`
    FOREIGN KEY (`seeker_id`)
    REFERENCES `sql6466143`.`boarding_house_seekers` (`seeker_id`),
  CONSTRAINT `fk_BOOKMARKS_ROOMS1`
    FOREIGN KEY (`room_id`)
    REFERENCES `sql6466143`.`rooms` (`room_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;


-- -----------------------------------------------------
-- Table `sql6466143`.`reviews`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql6466143`.`reviews` (
  ...
  INDEX `fk_REVIEWS_BOARDING_HOUSE_SEEKERS1_idx` (`seeker_id` ASC) ,
  INDEX `fk_REVIEWS_BOARDING_HOUSE1_idx` (`boardinghouse_id` ASC) ,
...
-- -----------------------------------------------------
-- Table `sql6466143`.`stars`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql6466143`.`stars` (
  `stars_id` INT NOT NULL AUTO_INCREMENT,
  `seeker_name` VARCHAR(100) NOT NULL,
  `seeker_id` INT NOT NULL,
  `boardinghouse_id` INT NOT NULL,
  PRIMARY KEY (`stars_id`),
  INDEX `fk_stars_boarding_house_seekers1_idx` (`seeker_id` ASC) ,
  INDEX `fk_stars_boarding_house1_idx` (`boardinghouse_id` ASC) ,
